import type { SproutsChainStoreRow } from './types';
import { formatCurrency, formatNumber } from '@/lib/format';

export interface SproutsTableColumn<TRow = SproutsChainStoreRow> {
  key: string;
  header: string;
  align?: 'left' | 'right';
...
export const SPROUTS_DETAIL_COLUMNS: SproutsTableColumn[] = [
